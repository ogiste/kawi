...
FLAVORS = {
    "llama-1B": llama3_2_1B,       # Keep original for compatibility
    "llama-100M": llama3_2_100M,   # Keep original for compatibility
}
...
class ModelArgs:
    ...
    backbone_flavor: str = "llama-1B"     # Keep original
    decoder_flavor: str = "llama-1B"      # Keep original
    text_vocab_size: int = 128_256        # Keep original Llama vocab size!
